                                        ...
                                        <tbody>
                                          <tr>
                                            <td align="center" class="esd-block-image es-p10t es-p10b" style="font-size:0px">
                                              <a target="_blank">
                                                <img src="https://fuibelc.stripocdn.email/content/guids/CABINET_f3fc38cf551f5b08f70308b6252772b8/images/96671618383886503.png" alt="" width="100" style="display:block">
                                              </a>
                                            </td>
                                          </tr>
                                          <tr>
                                          ...
                                          <tr>
                                            <td align="center" class="esd-block-button es-p10t es-p10b">
                                              <span class="es-button-border" style="border-radius:6px">
                                                <a href="${acceptLink}" target="_blank" class="es-button" style="border-left-width:30px;border-right-width:30px;border-radius:6px">
                                                  Accept
                                                </a>
                                              </span>
                                            </td>
                                          ...
                                          <tr>
                                            <td align="left" class="esd-block-text es-p20t es-p10b">
                                              <p style="line-height:150%">
                                                Got a question? Email us at&nbsp;<a target="_blank" href="mailto:">giahaonguyen2207@</a><a target="_blank" href="mailto:">gmail</a><a target="_blank" href="mailto:">.com</a>&nbsp;or give us a call at&nbsp;<a target="_blank" href="tel:" style="line-height:150%">+000 123 456</a>.
                                              </p>
                                              <p>
                                                <br>Thanks,
                                              </p>
