...
import { Balance, Category, Transaction, User } from "@/type";
  ...
  return (
    <div className="px-2 md:px-5 lg:px-10">
      <div className="flex items-end gap-4">
        ...
        <Badge className="text-sm mb-1 bg-black/10" variant={"secondary"}>
          {balance.id}
        </Badge>
      </div>
      ...
      <div className="my-4 grid grid-cols-2 gap-3 lg:grid-cols-3">
        ...
        <Card className="col-span-1 lg:order-3 order-2">
          <CardHeader>
            <CardTitle className="h2 text-gray-400">Owners</CardTitle>
          </CardHeader>
          <CardContent>
